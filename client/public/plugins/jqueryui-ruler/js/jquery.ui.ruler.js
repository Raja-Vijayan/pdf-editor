(function ($) {
    $.widget("ef.ruler", {
        ...
        _fixRulerSize: function () {
            ...
            this._$leftRuler.height((hContainer < hStage) ? (hStage - 30) : hContainer - this._scrollBarWidth);
        ...
        _updateRulerTicks: function (reset) {
            ...
            var leftRulerHeight = this._$leftRuler.height() - 15;
        ...
        _fixArrowsPosition: function (mouseX, mouseY) {
            ...
            this._$topArrow.css('left', arrowX + this._scrollLeft + $(window).scrollLeft() - 20);
            this._$leftArrow.css('top', arrowY + this._scrollTop + $(window).scrollTop() - 28);
        },

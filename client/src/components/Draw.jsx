...
export default function Draw({ storeDrawData }) {

    const [selectedColor, setSelectedColor] = useState('#0000ff');

    useEffect(() => {
        if (selectedColor) {
            storeDrawData({ selectedColor });
        }
    }, [selectedColor]);

    return (
        <div className='w-full h-full flex justify-evenly flex-col'>
            <div title='blue marker' className={`cursor-pointer hover:scale-125 transition-all duration-200 ease-in-out ${selectedColor === "#0000ff" && "scale-125"}`} onClick={() => setSelectedColor('#0000ff')} >
                <svg width="100" height="30" viewBox="0 0 185 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                    ...
                    <path
                        ...
                        stroke="blue" strokeOpacity=".1" strokeWidth=".75"></path>
                    ...
                    <path d="M163 18.57 108.92 4.31C106.5 3.5 104 3 104 1v49c0-2 2.5-2.5 4.51-3.08L163 33.06V18.57Z"
                        fill="url(#_2417137606__b)" fillOpacity=".3"></path>
                    <path d="M81 1H0v49h81V1Z" fill="#EEE"></path>
                    <path d="M81 1H0v49h81V1Z" fill="url(#_2417137606__c)"></path>
                    <path d="M81 1H0v49h81V1Z" fill="url(#_2417137606__d)" fillOpacity=".3"></path>
                    ...
                    <path d="M104 50V1c0-.55-.45-1-1-1H82c-.55 0-1 .45-1 1v49c0 .55.45 1 1 1h21c.55 0 1-.45 1-1Z"
                        fill="url(#_2417137606__f)" fillOpacity=".3"></path>
                    <path fillRule="evenodd" clipRule="evenodd"
                        ...
                        fill="url(#_2417137606__g)" fillOpacity=".1"></path>
                    <path d="M95 0h-6v51h6V0Z" fill="blue"></path>
                    <path d="M89.375 50.625V.375h5.25v50.25h-5.25Z" stroke="#0b3ee6" strokeOpacity=".1" strokeWidth=".75"></path>
                    <path
                    ...
                    <path
                        ...
                        stroke="blue" strokeOpacity=".07" strokeWidth=".75"></path>
                    <defs>
            ...
            <div title='red marker' className={`cursor-pointer hover:scale-125 transition-all duration-200 ease-in-out ${selectedColor === "#ff0000" && "scale-125"}`} onClick={() => setSelectedColor('#ff0000')} >
                <svg width="100" height="30" viewBox="0 0 184 49" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M161.96 35.07h-.5v-21h.5c11.5 0 21.5 4.7 21.5 10.5s-10 10.5-21.5 10.5Z" fill="red"></path>
                    <path
                    ...
                    <path d="M95 0h-6v49h6V0Z" fill="red"></path>
            ...
            <div title='Highlighter' className={`cursor-pointer hover:scale-125 transition-all duration-200 ease-in-out ${selectedColor === "#ffff00" && "scale-125"}`} onClick={() => setSelectedColor('#ffff00')} >
                <svg width="100" height="30" viewBox="0 0 183 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M176.25 15c.45 0 .84.3.96.73l5.43 19c.18.64-.3 1.27-.96 1.27H163V15h13.25Z" fill="yellow"></path>
                    ...
                    <path
                        ...
                        fill="url(#_301050800__c)" fillOpacity=".5"></path>
                    <path fillRule="evenodd" clipRule="evenodd"
                        ...
                        fill="#C9C9C9" fillOpacity=".5"></path>
                    <path d="M95 1h-6v49h6V1Z" fill="yellow"></path>
                    ...
                    <path
                        ...
                        stroke="url(#_301050800__e)" strokeOpacity=".07" strokeWidth=".75"></path>
                    <defs>
            ...
            <div>
                <input type='color' className='w-[100px] h-[40px] rounded-md cursor-pointer' id='color' onChange={(e) => setSelectedColor(e.target.value)} />
            </div>
        </div>
    )
}
